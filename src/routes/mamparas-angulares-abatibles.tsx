...
const sub = subcategoriaPorPath["/mamparas-angulares-abatibles"]!;

export const Route = createFileRoute("/mamparas-angulares-abatibles")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/mamparas-angulares-abatibles" },
    ],
    links: [{ rel: "canonical", href: "/mamparas-angulares-abatibles" }],
  }),
  component: () => (
