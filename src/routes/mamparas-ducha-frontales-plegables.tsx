...
const sub = subcategoriaPorPath["/mamparas-ducha-frontales-plegables"]!;

export const Route = createFileRoute("/mamparas-ducha-frontales-plegables")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/mamparas-ducha-frontales-plegables" },
    ],
    links: [{ rel: "canonical", href: "/mamparas-ducha-frontales-plegables" }],
  }),
  component: () => (
